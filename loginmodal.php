            ...
            <div class="modal-content">
				...
				<div class="container-fluid">
					<div class="form-group input-group">
						<span class="input-group-addon" style="color:#8d7252; font-size:20px;">Firstname:</span>
						<input type="text" style="width:350px;" class="form-control" id="fname">
					</div>
					<div class="form-group input-group">
						<span class="input-group-addon" style="color:#8d7252; font-size:20px;">Lastname:</span>
						<input type="text" style="width:350px;" class="form-control" id="lastname">
					</div>
					<div class="form-group input-group">
						<span class="input-group-addon"style="color:#8d7252; font-size:20px;">Address:</span>
						<input type="text" style="width:350px;" class="form-control" id="address">
					</div>
          <div class="form-group input-group">
						<span class="input-group-addon" style="color:#8d7252; font-size:20px;">Contact:</span>
						<input type="text" style="width:350px;" class="form-control" id="contact_num">
					</div>							
				</div>
				</div>
                <div class="modal-footer">
                    <button type="button" class="btn btn" style="background-color:#8d7252; color:white;" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Cancel</button>
                    <button type="button" class="btn btn" style="background-color:#EF9273; color:white;"><span class="glyphicon glyphicon-edit"></span> </i> Update</button>
                </div>
            </div>
        </div>
    </div>
